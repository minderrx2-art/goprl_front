...
<main
    class="grow flex flex-col justify-center container max-w-2xl mx-auto px-4 pb-12 mb-40 relative z-10"
>
    <Header />
    <div class="content space-y-8">
        ...
        >
            <div
                class="p-6 border rounded-xl bg-card text-card-foreground shadow-sm min-h-[110px] flex flex-col justify-center"
            >
                {#if result}
                    {#if result.short_url}
                        <div
